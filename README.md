...
2. Install the AWS Amplify CLI
   ...
   - Windows: [Find the Windows installer here]([https://docs.amplify.aws/cli/start/install/](https://d2td7dqidlhjx7.cloudfront.net/prod/global/windows/Amazon+WorkSpaces.msi))
